...
namespace MsgPack.Serialization.DefaultSerializers
{
    ...
    internal sealed class System_ByteMessagePackSerializer : MessagePackSerializer
    {
    ...
    internal sealed class System_CharMessagePackSerializer : MessagePackSerializer
    {
        public System_CharMessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(char), packerCompatibilityOptions) { }

        protected internal sealed override void PackToCore(Packer packer, object value)
        {
            packer.Pack((System.UInt16)(char)value);
        }
    ...
    internal sealed class System_DecimalMessagePackSerializer : MessagePackSerializer
    {
        public System_DecimalMessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(decimal), packerCompatibilityOptions) { }

        protected internal sealed override void PackToCore(Packer packer, object value)
        {
            packer.PackString(((decimal)value).ToString("G", CultureInfo.InvariantCulture));
        }
    ...
    internal sealed class System_DoubleMessagePackSerializer : MessagePackSerializer
    {
        public System_DoubleMessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(double), packerCompatibilityOptions) { }
    ...
    internal sealed class System_GuidMessagePackSerializer : MessagePackSerializer
    {
        public System_GuidMessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(Guid), packerCompatibilityOptions) { }

        protected internal sealed override void PackToCore(Packer packer, object value)
        {
            packer.PackRaw(((Guid)value).ToByteArray());
        }
    ...
    internal sealed class System_Int16MessagePackSerializer : MessagePackSerializer
    {
        public System_Int16MessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(short), packerCompatibilityOptions) { }

        protected internal sealed override void PackToCore(Packer packer, object value)
        {
            packer.Pack((short)value);
        }
    ...
    internal sealed class System_Int32MessagePackSerializer : MessagePackSerializer
    {
        public System_Int32MessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(int), packerCompatibilityOptions) { }
    ...
    internal sealed class System_Int64MessagePackSerializer : MessagePackSerializer
    {
        public System_Int64MessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(long), packerCompatibilityOptions) { }
    ...
    internal sealed class System_SByteMessagePackSerializer : MessagePackSerializer
    {
        public System_SByteMessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(sbyte), packerCompatibilityOptions) { }
    ...
    internal sealed class System_SingleMessagePackSerializer : MessagePackSerializer
    {
        public System_SingleMessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(float), packerCompatibilityOptions) { }
    ...
    internal sealed class System_TimeSpanMessagePackSerializer : MessagePackSerializer
    {
        public System_TimeSpanMessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(TimeSpan), packerCompatibilityOptions) { }

        protected internal sealed override void PackToCore(Packer packer, object value)
        {
            packer.Pack(((TimeSpan)value).Ticks);
        }
    ...
    internal sealed class System_UInt16MessagePackSerializer : MessagePackSerializer
    {
        public System_UInt16MessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(ushort), packerCompatibilityOptions) { }
    ...
    internal sealed class System_UInt32MessagePackSerializer : MessagePackSerializer
    {
        public System_UInt32MessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(uint), packerCompatibilityOptions) { }

        protected internal sealed override void PackToCore(Packer packer, object value)
        {
            packer.Pack((uint)value);
        }
    ...
    internal sealed class System_UInt64MessagePackSerializer : MessagePackSerializer
    {
        public System_UInt64MessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(ulong), packerCompatibilityOptions) { }

        protected internal sealed override void PackToCore(Packer packer, object value)
        {
            packer.Pack((ulong)value);
        }
    ...
    internal sealed class System_Collections_Specialized_BitVector32MessagePackSerializer : MessagePackSerializer
    {
        public System_Collections_Specialized_BitVector32MessagePackSerializer(PackerCompatibilityOptions packerCompatibilityOptions)
            : base(typeof(System.Collections.Specialized.BitVector32), packerCompatibilityOptions) { }

        protected internal sealed override void PackToCore(Packer packer, object value)
        {
            packer.Pack(((System.Collections.Specialized.BitVector32)value).Data);
        }
