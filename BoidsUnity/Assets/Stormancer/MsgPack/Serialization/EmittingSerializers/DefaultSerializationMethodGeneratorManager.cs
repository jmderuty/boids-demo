...
#else
            var emitSymbolInfo = false;
            if ( isDebuggable )
            {
                this._module = this._assembly.DefineDynamicModule( assemblyName, this._moduleFileName, emitSymbolInfo );
            }
            else
            {
                this._module = this._assembly.DefineDynamicModule(assemblyName, emitSymbolInfo);
            }
